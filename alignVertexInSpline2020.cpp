...
class alignVertexInSpline2020 : public UtilityObj, public QObject{
public:
	// Constructor/Destructor
	alignVertexInSpline2020();
	virtual ~alignVertexInSpline2020();
	...
	// Singleton access
	static alignVertexInSpline2020* GetInstance()
	{
		static alignVertexInSpline2020 thealignVertexInSpline2020;
...
public:
	...
	void*         Create(BOOL /*loading = FALSE*/) override         { return alignVertexInSpline2020::GetInstance(); }
...
//--- alignVertexInSpline2020 -------------------------------------------------------
alignVertexInSpline2020::alignVertexInSpline2020()
{
...
{
	alignVertexInSpline2020 *pAVIS = alignVertexInSpline2020::GetInstance();
	switch (message)
	{
	case WM_COMMAND:
...
void alignVertexInSpline2020::BeginEditParams(Interface* ip,IUtil* iu)
{
	if (mToolBar) {
...
void alignVertexInSpline2020::EndEditParams(Interface* ip, IUtil*)
{
}

void alignVertexInSpline2020::Init(HWND /*handle*/)
{

}

void alignVertexInSpline2020::Destroy(HWND /*handle*/)
{
